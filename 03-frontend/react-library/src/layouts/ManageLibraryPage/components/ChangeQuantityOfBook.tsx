...
const ChangeQuantityOfBook: React.FC<{
    ...
    useEffect(() => {
        const fetchBookInState = () => {
            props.book.copies ? setQuantity(props.book.copies)
                : setQuantity(0);
    ...
    return (
        <div className="card mt-3 shadow d-3 mb-3 bg-body rounded">
            <div className="row g-0">
                ...
                <button className="m1 btn btn-md main-color btn-outline-info text-white" onClick={increaseQuantity}>Add Quantity</button>
